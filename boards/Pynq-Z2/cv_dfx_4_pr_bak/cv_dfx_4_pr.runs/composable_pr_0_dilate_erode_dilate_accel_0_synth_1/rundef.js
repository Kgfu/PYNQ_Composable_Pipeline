...
ISEStep( "vivado",
         "-log composable_pr_0_dilate_erode_dilate_accel_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source composable_pr_0_dilate_erode_dilate_accel_0.tcl" );
