...
ISEStep( "vivado",
         "-log composable_pr_fork_duplicate_duplicate_accel_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source composable_pr_fork_duplicate_duplicate_accel_0.tcl" );
