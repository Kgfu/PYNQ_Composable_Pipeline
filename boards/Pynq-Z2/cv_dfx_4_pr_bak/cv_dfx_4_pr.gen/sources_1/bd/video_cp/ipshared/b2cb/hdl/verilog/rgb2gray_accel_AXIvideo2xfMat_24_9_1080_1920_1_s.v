...
module rgb2gray_accel_AXIvideo2xfMat_24_9_1080_1920_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
output   start_out;
output   start_write;
output  [23:0] img_in_433_din;
input   img_in_433_full_n;
output   img_in_433_write;
...
always @ (*) begin
    if (((icmp_ln132_reg_491 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        img_in_433_blk_n = img_in_433_full_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln132_reg_491 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        img_in_433_write = 1'b1;
    end else begin
        img_in_433_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_433_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_433_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_433_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = ((icmp_ln132_reg_491 == 1'd0) & (img_in_433_full_n == 1'b0));
end
...
assign img_in_433_din = p_Val2_s_reg_282;
...
endmodule //rgb2gray_accel_AXIvideo2xfMat_24_9_1080_1920_1_s
