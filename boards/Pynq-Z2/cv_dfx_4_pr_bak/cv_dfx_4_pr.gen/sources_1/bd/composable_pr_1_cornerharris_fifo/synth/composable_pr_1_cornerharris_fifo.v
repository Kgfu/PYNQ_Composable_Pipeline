...
module composable_pr_1_cornerharris_fifo
  ...
  wire clk_142M_1;
  wire [23:0]cornerHarris_accel_stream_out_TDATA;
  wire [0:0]cornerHarris_accel_stream_out_TDEST;
  wire [0:0]cornerHarris_accel_stream_out_TID;
  wire [2:0]cornerHarris_accel_stream_out_TKEEP;
  wire [0:0]cornerHarris_accel_stream_out_TLAST;
  wire cornerHarris_accel_stream_out_TREADY;
  wire [2:0]cornerHarris_accel_stream_out_TSTRB;
  wire [0:0]cornerHarris_accel_stream_out_TUSER;
  wire cornerHarris_accel_stream_out_TVALID;
  ...
  assign cornerHarris_accel_stream_out_TREADY = stream_out0_tready;
  ...
  assign stream_out0_tdata[23:0] = cornerHarris_accel_stream_out_TDATA;
  assign stream_out0_tdest[0] = cornerHarris_accel_stream_out_TDEST;
  assign stream_out0_tid[0] = cornerHarris_accel_stream_out_TID;
  assign stream_out0_tkeep[2:0] = cornerHarris_accel_stream_out_TKEEP;
  assign stream_out0_tlast[0] = cornerHarris_accel_stream_out_TLAST;
  assign stream_out0_tstrb[2:0] = cornerHarris_accel_stream_out_TSTRB;
  assign stream_out0_tuser[0] = cornerHarris_accel_stream_out_TUSER;
  assign stream_out0_tvalid = cornerHarris_accel_stream_out_TVALID;
  ...
  composable_pr_1_cornerharris_fifo_axis_data_fifo_0_0 axis_data_fifo_0
  ...
  composable_pr_1_cornerharris_fifo_cornerHarris_accel_0 cornerHarris_accel
       (.ap_clk(clk_142M_1),
        ...
        .stream_out_TDATA(cornerHarris_accel_stream_out_TDATA),
        .stream_out_TDEST(cornerHarris_accel_stream_out_TDEST),
        .stream_out_TID(cornerHarris_accel_stream_out_TID),
        .stream_out_TKEEP(cornerHarris_accel_stream_out_TKEEP),
        .stream_out_TLAST(cornerHarris_accel_stream_out_TLAST),
        .stream_out_TREADY(cornerHarris_accel_stream_out_TREADY),
        .stream_out_TSTRB(cornerHarris_accel_stream_out_TSTRB),
        .stream_out_TUSER(cornerHarris_accel_stream_out_TUSER),
        .stream_out_TVALID(cornerHarris_accel_stream_out_TVALID));
endmodule
