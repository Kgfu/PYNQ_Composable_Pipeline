...
-- Date        : Wed Mar 16 11:41:47 2022
-- Host        : ubuntu3 running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/willychiang/Desktop/PYNQ_Composable_Pipeline/boards/Pynq-Z2/cv_dfx_4_pr/cv_dfx_4_pr.gen/sources_1/bd/composable_pr_1_cornerharris_fifo/composable_pr_1_cornerharris_fifo_sim_netlist.vhdl
-- Design      : composable_pr_1_cornerharris_fifo
...
entity composable_pr_1_cornerharris_fifo is
  port (
  ...
  attribute NotValidForBitStream of composable_pr_1_cornerharris_fifo : entity is true;
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of composable_pr_1_cornerharris_fifo : entity is "composable_pr_1_cornerharris_fifo.hwdef";
end composable_pr_1_cornerharris_fifo;

architecture STRUCTURE of composable_pr_1_cornerharris_fifo is
  component composable_pr_1_cornerharris_fifo_composable_pr_1_cornerharris_fifo_axis_data_fifo_0_0 is
  port (
  ...
  end component composable_pr_1_cornerharris_fifo_composable_pr_1_cornerharris_fifo_axis_data_fifo_0_0;
  component composable_pr_1_cornerharris_fifo_composable_pr_1_cornerharris_fifo_cornerHarris_accel_0 is
  port (
  ...
  end component composable_pr_1_cornerharris_fifo_composable_pr_1_cornerharris_fifo_cornerHarris_accel_0;
  signal \<const0>\ : STD_LOGIC;
  signal NLW_cornerHarris_accel_interrupt_UNCONNECTED : STD_LOGIC;
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of axis_data_fifo_0 : label is "axis_data_fifo_v2_0_4_top,Vivado 2020.2.2";
  attribute X_CORE_INFO of cornerHarris_accel : label is "cornerHarris_accel,Vivado 2020.2.2";
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk_142M : signal is "xilinx.com:signal:clock:1.0 CLK.CLK_142M CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk_142M : signal is "XIL_INTERFACENAME CLK.CLK_142M, ASSOCIATED_BUSIF s_axi_control0:s_axi_control1:stream_in0:stream_in1:stream_out0:stream_out1, ASSOCIATED_RESET periph_resetn_clk142M, CLK_DOMAIN composable_pr_1_dilate_erode_clk_142M, FREQ_HZ 142857132, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
  ...
  attribute X_INTERFACE_PARAMETER of s_axi_control0_araddr : signal is "XIL_INTERFACENAME s_axi_control0, ADDR_WIDTH 31, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN composable_pr_1_dilate_erode_clk_142M, DATA_WIDTH 32, FREQ_HZ 142857132, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0";
  ...
  attribute X_INTERFACE_PARAMETER of s_axi_control1_araddr : signal is "XIL_INTERFACENAME s_axi_control1, ADDR_WIDTH 31, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN composable_pr_1_dilate_erode_clk_142M, DATA_WIDTH 32, FREQ_HZ 142857132, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0";
  ...
  attribute X_INTERFACE_PARAMETER of stream_in0_tdata : signal is "XIL_INTERFACENAME stream_in0, CLK_DOMAIN composable_pr_1_dilate_erode_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
  ...
  attribute X_INTERFACE_PARAMETER of stream_in1_tdata : signal is "XIL_INTERFACENAME stream_in1, CLK_DOMAIN composable_pr_1_dilate_erode_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
  ...
  attribute X_INTERFACE_PARAMETER of stream_out0_tdata : signal is "XIL_INTERFACENAME stream_out0, CLK_DOMAIN composable_pr_1_dilate_erode_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
  ...
  attribute X_INTERFACE_PARAMETER of stream_out1_tdata : signal is "XIL_INTERFACENAME stream_out1, CLK_DOMAIN composable_pr_1_dilate_erode_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
...
begin
  s_axi_control1_arready <= \<const0>\;
  s_axi_control1_awready <= \<const0>\;
  s_axi_control1_bresp(1) <= \<const0>\;
  s_axi_control1_bresp(0) <= \<const0>\;
  s_axi_control1_bvalid <= \<const0>\;
  s_axi_control1_rdata(31) <= \<const0>\;
  s_axi_control1_rdata(30) <= \<const0>\;
  s_axi_control1_rdata(29) <= \<const0>\;
  s_axi_control1_rdata(28) <= \<const0>\;
  s_axi_control1_rdata(27) <= \<const0>\;
  s_axi_control1_rdata(26) <= \<const0>\;
  s_axi_control1_rdata(25) <= \<const0>\;
  s_axi_control1_rdata(24) <= \<const0>\;
  s_axi_control1_rdata(23) <= \<const0>\;
  s_axi_control1_rdata(22) <= \<const0>\;
  s_axi_control1_rdata(21) <= \<const0>\;
  s_axi_control1_rdata(20) <= \<const0>\;
  s_axi_control1_rdata(19) <= \<const0>\;
  s_axi_control1_rdata(18) <= \<const0>\;
  s_axi_control1_rdata(17) <= \<const0>\;
  s_axi_control1_rdata(16) <= \<const0>\;
  s_axi_control1_rdata(15) <= \<const0>\;
  s_axi_control1_rdata(14) <= \<const0>\;
  s_axi_control1_rdata(13) <= \<const0>\;
  s_axi_control1_rdata(12) <= \<const0>\;
  s_axi_control1_rdata(11) <= \<const0>\;
  s_axi_control1_rdata(10) <= \<const0>\;
  s_axi_control1_rdata(9) <= \<const0>\;
  s_axi_control1_rdata(8) <= \<const0>\;
  s_axi_control1_rdata(7) <= \<const0>\;
  s_axi_control1_rdata(6) <= \<const0>\;
  s_axi_control1_rdata(5) <= \<const0>\;
  s_axi_control1_rdata(4) <= \<const0>\;
  s_axi_control1_rdata(3) <= \<const0>\;
  s_axi_control1_rdata(2) <= \<const0>\;
  s_axi_control1_rdata(1) <= \<const0>\;
  s_axi_control1_rdata(0) <= \<const0>\;
  s_axi_control1_rresp(1) <= \<const0>\;
  s_axi_control1_rresp(0) <= \<const0>\;
  s_axi_control1_rvalid <= \<const0>\;
  s_axi_control1_wready <= \<const0>\;
GND: unisim.vcomponents.GND
     port map (
      G => \<const0>\
    );
axis_data_fifo_0: component composable_pr_1_cornerharris_fifo_composable_pr_1_cornerharris_fifo_axis_data_fifo_0_0
     port map (
      m_axis_tdata(23 downto 0) => stream_out1_tdata(23 downto 0),
      m_axis_tdest(0) => stream_out1_tdest(0),
      m_axis_tid(0) => stream_out1_tid(0),
      m_axis_tkeep(2 downto 0) => stream_out1_tkeep(2 downto 0),
      m_axis_tlast => stream_out1_tlast(0),
      m_axis_tready => stream_out1_tready,
      m_axis_tstrb(2 downto 0) => stream_out1_tstrb(2 downto 0),
      m_axis_tuser(0) => stream_out1_tuser(0),
      m_axis_tvalid => stream_out1_tvalid,
      s_axis_aclk => clk_142M,
      s_axis_aresetn => periph_resetn_clk142M,
      s_axis_tdata(23 downto 0) => stream_in1_tdata(23 downto 0),
      s_axis_tdest(0) => stream_in1_tdest(0),
      s_axis_tid(0) => stream_in1_tid(0),
      s_axis_tkeep(2 downto 0) => stream_in1_tkeep(2 downto 0),
      s_axis_tlast => stream_in1_tlast(0),
      s_axis_tready => stream_in1_tready,
      s_axis_tstrb(2 downto 0) => stream_in1_tstrb(2 downto 0),
      s_axis_tuser(0) => stream_in1_tuser(0),
      s_axis_tvalid => stream_in1_tvalid
    );
cornerHarris_accel: component composable_pr_1_cornerharris_fifo_composable_pr_1_cornerharris_fifo_cornerHarris_accel_0
     port map (
      ap_clk => clk_142M,
      ap_rst_n => periph_resetn_clk142M,
      interrupt => NLW_cornerHarris_accel_interrupt_UNCONNECTED,
      s_axi_control_ARADDR(5 downto 0) => s_axi_control0_araddr(5 downto 0),
      s_axi_control_ARREADY => s_axi_control0_arready,
      s_axi_control_ARVALID => s_axi_control0_arvalid,
      s_axi_control_AWADDR(5 downto 0) => s_axi_control0_awaddr(5 downto 0),
