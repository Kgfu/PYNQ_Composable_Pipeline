...
//Command     : generate_target composable_pr_join_bitand.bd
//Design      : composable_pr_join_bitand
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "composable_pr_join_bitand,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=composable_pr_join_bitand,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "composable_pr_join_bitand.hwdef" *) 
module composable_pr_join_bitand
   (clk_142M,
  ...
  wire [23:0]bitwise_and_accel_stream_out_TDATA;
  wire [0:0]bitwise_and_accel_stream_out_TDEST;
  wire [0:0]bitwise_and_accel_stream_out_TID;
  wire [2:0]bitwise_and_accel_stream_out_TKEEP;
  wire [0:0]bitwise_and_accel_stream_out_TLAST;
  wire bitwise_and_accel_stream_out_TREADY;
  wire [2:0]bitwise_and_accel_stream_out_TSTRB;
  wire [0:0]bitwise_and_accel_stream_out_TUSER;
  wire bitwise_and_accel_stream_out_TVALID;
  wire clk_142M_1;
  ...
  assign bitwise_and_accel_stream_out_TREADY = stream_out_tready;
  ...
  assign stream_out_tdata[23:0] = bitwise_and_accel_stream_out_TDATA;
  assign stream_out_tdest[0] = bitwise_and_accel_stream_out_TDEST;
  assign stream_out_tid[0] = bitwise_and_accel_stream_out_TID;
  assign stream_out_tkeep[2:0] = bitwise_and_accel_stream_out_TKEEP;
  assign stream_out_tlast[0] = bitwise_and_accel_stream_out_TLAST;
  assign stream_out_tstrb[2:0] = bitwise_and_accel_stream_out_TSTRB;
  assign stream_out_tuser[0] = bitwise_and_accel_stream_out_TUSER;
  assign stream_out_tvalid = bitwise_and_accel_stream_out_TVALID;
  composable_pr_join_bitand_bitwise_and_accel_0 bitwise_and_accel
       (.ap_clk(clk_142M_1),
        ...
        .stream_out_TDATA(bitwise_and_accel_stream_out_TDATA),
        .stream_out_TDEST(bitwise_and_accel_stream_out_TDEST),
        .stream_out_TID(bitwise_and_accel_stream_out_TID),
        .stream_out_TKEEP(bitwise_and_accel_stream_out_TKEEP),
        .stream_out_TLAST(bitwise_and_accel_stream_out_TLAST),
        .stream_out_TREADY(bitwise_and_accel_stream_out_TREADY),
        .stream_out_TSTRB(bitwise_and_accel_stream_out_TSTRB),
        .stream_out_TUSER(bitwise_and_accel_stream_out_TUSER),
        .stream_out_TVALID(bitwise_and_accel_stream_out_TVALID));
endmodule
