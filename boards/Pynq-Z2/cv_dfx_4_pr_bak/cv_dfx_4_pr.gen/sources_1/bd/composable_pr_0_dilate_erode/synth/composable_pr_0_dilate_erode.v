...
//Command     : generate_target composable_pr_0_dilate_erode.bd
//Design      : composable_pr_0_dilate_erode
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "composable_pr_0_dilate_erode,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=composable_pr_0_dilate_erode,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=2,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "composable_pr_0_dilate_erode.hwdef" *) 
module composable_pr_0_dilate_erode
  ...
  composable_pr_0_dilate_erode_dilate_accel_0 dilate_accel
       (.ap_clk(clk_142M_1),
  ...
  composable_pr_0_dilate_erode_erode_accel_0 erode_accel
       (.ap_clk(clk_142M_1),
        .ap_rst_n(periph_resetn_clk142M_1),
