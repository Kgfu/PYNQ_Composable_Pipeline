...
module dilate_accel_AXIvideo2xfMat_24_9_1080_1920_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((ap_enable_reg_pp1_iter0 == 1'b1) & (stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1)) | ((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_419_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((ap_enable_reg_pp1_iter0 == 1'b1) & (stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1)) | ((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_419_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((ap_enable_reg_pp1_iter0 == 1'b1) & (stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1)) | ((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_419_full_n == 1'b0)));
end
...
endmodule //dilate_accel_AXIvideo2xfMat_24_9_1080_1920_1_s
