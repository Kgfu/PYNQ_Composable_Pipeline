...
//Command     : generate_target composable_pr_join_add_wrapper.bd
//Design      : composable_pr_join_add_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module composable_pr_join_add_wrapper
   (clk_142M,
  ...
  composable_pr_join_add composable_pr_join_add_i
       (.clk_142M(clk_142M),
