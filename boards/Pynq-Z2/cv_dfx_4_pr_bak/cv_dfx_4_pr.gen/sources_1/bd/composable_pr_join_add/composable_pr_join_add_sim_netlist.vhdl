...
--               /home/willychiang/Desktop/PYNQ_Composable_Pipeline/boards/Pynq-Z2/cv_dfx_4_pr/cv_dfx_4_pr.gen/sources_1/bd/composable_pr_join_add/composable_pr_join_add_sim_netlist.vhdl
...
entity composable_pr_join_add is
  port (
  ...
  attribute NotValidForBitStream of composable_pr_join_add : entity is true;
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of composable_pr_join_add : entity is "composable_pr_join_add.hwdef";
end composable_pr_join_add;

architecture STRUCTURE of composable_pr_join_add is
  component composable_pr_join_add_composable_pr_join_add_add_accel_0 is
  port (
    s_axi_control_AWADDR : in STD_LOGIC_VECTOR ( 4 downto 0 );
    s_axi_control_AWVALID : in STD_LOGIC;
    s_axi_control_AWREADY : out STD_LOGIC;
  ...
  end component composable_pr_join_add_composable_pr_join_add_add_accel_0;
  signal NLW_add_accel_interrupt_UNCONNECTED : STD_LOGIC;
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of add_accel : label is "add_accel,Vivado 2020.2.2";
...
begin
add_accel: component composable_pr_join_add_composable_pr_join_add_add_accel_0
     port map (
      ap_clk => clk_142M,
      ap_rst_n => periph_resetn_clk142M,
      interrupt => NLW_add_accel_interrupt_UNCONNECTED,
