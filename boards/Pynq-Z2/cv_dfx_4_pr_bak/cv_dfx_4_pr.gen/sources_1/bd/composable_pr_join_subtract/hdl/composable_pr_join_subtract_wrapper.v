...
//Command     : generate_target composable_pr_join_subtract_wrapper.bd
//Design      : composable_pr_join_subtract_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module composable_pr_join_subtract_wrapper
   (clk_142M,
  ...
  composable_pr_join_subtract composable_pr_join_subtract_i
       (.clk_142M(clk_142M),
