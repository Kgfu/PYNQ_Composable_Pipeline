...
//Command     : generate_target composable_pr_0_filter2d_fifo.bd
//Design      : composable_pr_0_filter2d_fifo
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "composable_pr_0_filter2d_fifo,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=composable_pr_0_filter2d_fifo,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "composable_pr_0_filter2d_fifo.hwdef" *) 
module composable_pr_0_filter2d_fifo
  ...
  wire [23:0]axis_data_fifo_1_M_AXIS_TDATA;
  wire [0:0]axis_data_fifo_1_M_AXIS_TDEST;
  wire [0:0]axis_data_fifo_1_M_AXIS_TID;
  wire [2:0]axis_data_fifo_1_M_AXIS_TKEEP;
  wire axis_data_fifo_1_M_AXIS_TLAST;
  wire axis_data_fifo_1_M_AXIS_TREADY;
  wire [2:0]axis_data_fifo_1_M_AXIS_TSTRB;
  wire [0:0]axis_data_fifo_1_M_AXIS_TUSER;
  wire axis_data_fifo_1_M_AXIS_TVALID;
  wire clk_142M_1;
  wire [23:0]filter2d_accel_stream_out_TDATA;
  wire [0:0]filter2d_accel_stream_out_TDEST;
  wire [0:0]filter2d_accel_stream_out_TID;
  wire [2:0]filter2d_accel_stream_out_TKEEP;
  wire [0:0]filter2d_accel_stream_out_TLAST;
  wire filter2d_accel_stream_out_TREADY;
  wire [2:0]filter2d_accel_stream_out_TSTRB;
  wire [0:0]filter2d_accel_stream_out_TUSER;
  wire filter2d_accel_stream_out_TVALID;
  ...
  assign axis_data_fifo_1_M_AXIS_TREADY = stream_out1_tready;
  assign clk_142M_1 = clk_142M;
  assign filter2d_accel_stream_out_TREADY = stream_out0_tready;
  ...
  assign stream_out0_tdata[23:0] = filter2d_accel_stream_out_TDATA;
  assign stream_out0_tdest[0] = filter2d_accel_stream_out_TDEST;
  assign stream_out0_tid[0] = filter2d_accel_stream_out_TID;
  assign stream_out0_tkeep[2:0] = filter2d_accel_stream_out_TKEEP;
  assign stream_out0_tlast[0] = filter2d_accel_stream_out_TLAST;
  assign stream_out0_tstrb[2:0] = filter2d_accel_stream_out_TSTRB;
  assign stream_out0_tuser[0] = filter2d_accel_stream_out_TUSER;
  assign stream_out0_tvalid = filter2d_accel_stream_out_TVALID;
  assign stream_out1_tdata[23:0] = axis_data_fifo_1_M_AXIS_TDATA;
  assign stream_out1_tdest[0] = axis_data_fifo_1_M_AXIS_TDEST;
  assign stream_out1_tid[0] = axis_data_fifo_1_M_AXIS_TID;
  assign stream_out1_tkeep[2:0] = axis_data_fifo_1_M_AXIS_TKEEP;
  assign stream_out1_tlast[0] = axis_data_fifo_1_M_AXIS_TLAST;
  assign stream_out1_tstrb[2:0] = axis_data_fifo_1_M_AXIS_TSTRB;
  assign stream_out1_tuser[0] = axis_data_fifo_1_M_AXIS_TUSER;
  assign stream_out1_tvalid = axis_data_fifo_1_M_AXIS_TVALID;
  composable_pr_0_filter2d_fifo_axis_data_fifo_1_0 axis_data_fifo_1
  ...
  composable_pr_0_filter2d_fifo_filter2d_accel_0 filter2d_accel
       (.ap_clk(clk_142M_1),
        ...
        .stream_out_TDATA(filter2d_accel_stream_out_TDATA),
        .stream_out_TDEST(filter2d_accel_stream_out_TDEST),
        .stream_out_TID(filter2d_accel_stream_out_TID),
        .stream_out_TKEEP(filter2d_accel_stream_out_TKEEP),
        .stream_out_TLAST(filter2d_accel_stream_out_TLAST),
        .stream_out_TREADY(filter2d_accel_stream_out_TREADY),
        .stream_out_TSTRB(filter2d_accel_stream_out_TSTRB),
        .stream_out_TUSER(filter2d_accel_stream_out_TUSER),
        .stream_out_TVALID(filter2d_accel_stream_out_TVALID));
endmodule
