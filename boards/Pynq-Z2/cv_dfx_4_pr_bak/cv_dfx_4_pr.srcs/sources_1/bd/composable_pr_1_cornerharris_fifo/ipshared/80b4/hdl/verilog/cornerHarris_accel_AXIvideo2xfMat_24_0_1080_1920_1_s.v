...
module cornerHarris_accel_AXIvideo2xfMat_24_0_1080_1920_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_block_state2;
reg    ap_block_state8;
reg   [31:0] rows_reg_443;
reg   [31:0] cols_reg_448;
wire   [0:0] cmp743_i_fu_385_p2;
reg   [0:0] cmp743_i_reg_471;
wire    ap_CS_fsm_state3;
wire   [10:0] i_2_fu_395_p2;
reg   [10:0] i_2_reg_475;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln128_fu_408_p2;
...
reg   [23:0] axi_data_V_5_reg_343;
reg   [0:0] axi_last_V_2_reg_204;
reg   [0:0] axi_last_V_5_reg_331;
...
reg   [0:0] ap_phi_mux_axi_last_V_5_ph_phi_fu_297_p4;
reg   [0:0] axi_last_V_5_ph_reg_294;
wire    ap_CS_fsm_state7;
reg   [23:0] ap_phi_mux_axi_data_V_5_ph_phi_fu_309_p4;
reg   [23:0] axi_data_V_5_ph_reg_306;
reg   [0:0] ap_phi_mux_last_1_ph_phi_fu_322_p4;
reg   [0:0] last_1_ph_reg_318;
reg   [0:0] last_1_reg_355;
reg   [0:0] start_1_fu_90;
reg    ap_block_pp1_stage0_01001;
wire   [31:0] zext_ln128_fu_404_p1;
wire   [31:0] zext_ln132_fu_419_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
...
cornerHarris_accel_regslice_both #(
    .DataWidth( 24 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b1 == ap_condition_pp1_exit_iter0_state5))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd1) & (cmp743_i_reg_471 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        axi_data_V_2_reg_193 <= axi_data_V_5_reg_343;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd1) & (cmp743_i_reg_471 == 1'd1))) begin
        axi_data_V_3_reg_248 <= axi_data_V_2_reg_193;
    end else if (((icmp_ln132_reg_494 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        axi_data_V_3_reg_248 <= p_Val2_s_reg_282;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (cmp743_i_reg_471 == 1'd1))) begin
        axi_data_V_5_ph_reg_306 <= axi_data_V_3_reg_248;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd1) & (cmp743_i_reg_471 == 1'd0))) begin
        axi_data_V_5_ph_reg_306 <= axi_data_V_2_reg_193;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        axi_data_V_5_reg_343 <= ap_phi_mux_axi_data_V_5_ph_phi_fu_309_p4;
    end else if ((~((stream_in_TVALID_int_regslice == 1'b0) & (last_1_reg_355 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (last_1_reg_355 == 1'd0))) begin
        axi_data_V_5_reg_343 <= stream_in_TDATA_int_regslice;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        axi_last_V_2_reg_204 <= axi_last_V_5_reg_331;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (cmp743_i_reg_471 == 1'd1))) begin
        axi_last_V_5_ph_reg_294 <= last_reg_226;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd1) & (cmp743_i_reg_471 == 1'd0))) begin
        axi_last_V_5_ph_reg_294 <= axi_last_V_2_reg_204;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        axi_last_V_5_reg_331 <= ap_phi_mux_axi_last_V_5_ph_phi_fu_297_p4;
    end else if ((~((stream_in_TVALID_int_regslice == 1'b0) & (last_1_reg_355 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (last_1_reg_355 == 1'd0))) begin
        axi_last_V_5_reg_331 <= stream_in_TLAST_int_regslice;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_183)) begin
        if (((or_ln138_fu_428_p2 == 1'd1) & (icmp_ln132_fu_423_p2 == 1'd0))) begin
            axi_last_V_8_reg_269 <= ap_phi_mux_axi_last_V_3_phi_fu_262_p4;
        end else if (((or_ln138_fu_428_p2 == 1'd0) & (icmp_ln132_fu_423_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd1) & (cmp743_i_reg_471 == 1'd1))) begin
        j_reg_215 <= 11'd0;
    end else if (((icmp_ln132_fu_423_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        j_reg_215 <= j_2_fu_413_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (cmp743_i_reg_471 == 1'd1))) begin
        last_1_ph_reg_318 <= last_reg_226;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd1) & (cmp743_i_reg_471 == 1'd0))) begin
        last_1_ph_reg_318 <= 1'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        last_1_reg_355 <= ap_phi_mux_last_1_ph_phi_fu_322_p4;
    end else if ((~((stream_in_TVALID_int_regslice == 1'b0) & (last_1_reg_355 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (last_1_reg_355 == 1'd0))) begin
        last_1_reg_355 <= stream_in_TLAST_int_regslice;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        start_1_fu_90 <= 1'd1;
    end else if (((1'b1 == ap_CS_fsm_state7) & (cmp743_i_reg_471 == 1'd1))) begin
        start_1_fu_90 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((img_2_out_full_n == 1'b0) | (img_1_out_full_n == 1'b0) | (img_2_empty_n == 1'b0) | (img_1_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        start_reg_171 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        cmp743_i_reg_471 <= cmp743_i_fu_385_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        cols_reg_448 <= img_2_dout;
        rows_reg_443 <= img_1_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        i_2_reg_475 <= i_2_fu_395_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        icmp_ln132_reg_494 <= icmp_ln132_fu_423_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln132_fu_423_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        trunc_ln674_reg_502 <= trunc_ln674_fu_434_p1;
    end
end

always @ (*) begin
    if ((icmp_ln132_fu_423_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd0))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln132_reg_494 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) & (cmp743_i_reg_471 == 1'd1))) begin
        ap_phi_mux_axi_data_V_5_ph_phi_fu_309_p4 = axi_data_V_3_reg_248;
    end else begin
        ap_phi_mux_axi_data_V_5_ph_phi_fu_309_p4 = axi_data_V_5_ph_reg_306;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) & (cmp743_i_reg_471 == 1'd1))) begin
        ap_phi_mux_axi_last_V_5_ph_phi_fu_297_p4 = last_reg_226;
    end else begin
        ap_phi_mux_axi_last_V_5_ph_phi_fu_297_p4 = axi_last_V_5_ph_reg_294;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) & (cmp743_i_reg_471 == 1'd1))) begin
        ap_phi_mux_last_1_ph_phi_fu_322_p4 = last_reg_226;
    end else begin
        ap_phi_mux_last_1_ph_phi_fu_322_p4 = last_1_ph_reg_318;
    end
end
...
always @ (*) begin
    if ((icmp_ln132_fu_423_p2 == 1'd0)) begin
        if ((or_ln138_fu_428_p2 == 1'd1)) begin
            ap_phi_mux_p_Val2_s_phi_fu_286_p4 = ap_phi_mux_axi_data_V_3_phi_fu_251_p4;
        end else if ((or_ln138_fu_428_p2 == 1'd0)) begin
            ap_phi_mux_p_Val2_s_phi_fu_286_p4 = stream_in_TDATA_int_regslice;
        end else begin
...
always @ (*) begin
    if (((icmp_ln132_reg_494 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((or_ln138_fu_428_p2 == 1'd0) & (icmp_ln132_fu_423_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((start_reg_171 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | ((1'b1 == ap_CS_fsm_state8) & (last_1_reg_355 == 1'd0)))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op72_read_state5 == 1'b1)) | (~((stream_in_TVALID_int_regslice == 1'b0) & (last_1_reg_355 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (last_1_reg_355 == 1'd0)) | (~((start_reg_171 == 1'd0) & (stream_in_TVALID_int_regslice == 1'b0)) & (start_reg_171 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((icmp_ln132_fu_423_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((icmp_ln132_fu_423_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end
        ...
        ap_ST_fsm_state8 : begin
            if ((~((stream_in_TVALID_int_regslice == 1'b0) & (last_1_reg_355 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (last_1_reg_355 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((stream_in_TVALID_int_regslice == 1'b0) & (last_1_reg_355 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (ap_phi_mux_last_1_phi_fu_358_p4 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((ap_enable_reg_pp1_iter0 == 1'b1) & (stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1)) | ((icmp_ln132_reg_494 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_419_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((ap_enable_reg_pp1_iter0 == 1'b1) & (stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1)) | ((icmp_ln132_reg_494 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_419_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((ap_enable_reg_pp1_iter0 == 1'b1) & (stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1)) | ((icmp_ln132_reg_494 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in_419_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((img_2_out_full_n == 1'b0) | (img_1_out_full_n == 1'b0) | (img_2_empty_n == 1'b0) | (img_1_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = ((icmp_ln132_reg_494 == 1'd0) & (img_in_419_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state8 = ((stream_in_TVALID_int_regslice == 1'b0) & (last_1_reg_355 == 1'd0));
end

always @ (*) begin
    ap_condition_183 = ((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0));
end

assign ap_enable_pp1 = (ap_idle_pp1 ^ 1'b1);

assign ap_phi_mux_last_1_phi_fu_358_p4 = last_1_reg_355;
...
always @ (*) begin
    ap_predicate_op72_read_state5 = ((or_ln138_fu_428_p2 == 1'd0) & (icmp_ln132_fu_423_p2 == 1'd0));
end

assign cmp743_i_fu_385_p2 = (($signed(cols_reg_448) > $signed(32'd0)) ? 1'b1 : 1'b0);

assign i_2_fu_395_p2 = (i_reg_182 + 11'd1);

assign icmp_ln128_fu_408_p2 = (($signed(zext_ln128_fu_404_p1) < $signed(rows_reg_443)) ? 1'b1 : 1'b0);

assign icmp_ln132_fu_423_p2 = ((zext_ln132_fu_419_p1 == cols_reg_448) ? 1'b1 : 1'b0);

assign img_1_out_din = img_1_dout;

assign img_2_out_din = img_2_dout;

assign img_in_419_din = trunc_ln674_reg_502;

assign j_2_fu_413_p2 = (j_reg_215 + 11'd1);

assign or_ln138_fu_428_p2 = (ap_phi_mux_start_3_phi_fu_241_p4 | ap_phi_mux_last_phi_fu_230_p4);

assign stream_in_TREADY = regslice_both_AXI_video_strm_V_data_V_U_ack_in;

assign trunc_ln674_fu_434_p1 = ap_phi_mux_p_Val2_s_phi_fu_286_p4[7:0];

assign zext_ln128_fu_404_p1 = i_reg_182;

assign zext_ln132_fu_419_p1 = j_reg_215;

endmodule //cornerHarris_accel_AXIvideo2xfMat_24_0_1080_1920_1_s
