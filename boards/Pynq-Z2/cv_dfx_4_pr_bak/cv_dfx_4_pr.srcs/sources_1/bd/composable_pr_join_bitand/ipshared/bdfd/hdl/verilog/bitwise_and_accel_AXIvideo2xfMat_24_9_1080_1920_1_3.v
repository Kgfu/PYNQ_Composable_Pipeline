...
module bitwise_and_accel_AXIvideo2xfMat_24_9_1080_1920_1_3 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
bitwise_and_accel_regslice_both #(
    .DataWidth( 24 ))
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in0_434_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in0_434_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((icmp_ln132_reg_491 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_in0_434_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = ((icmp_ln132_reg_491 == 1'd0) & (img_in0_434_full_n == 1'b0));
end
...
assign img_in0_434_din = p_Val2_s_reg_282;
...
endmodule //bitwise_and_accel_AXIvideo2xfMat_24_9_1080_1920_1_3
