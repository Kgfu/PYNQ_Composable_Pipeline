...
HD_PWD='/home/willychiang/Desktop/PYNQ_Composable_Pipeline/boards/Pynq-Z2/cv_dfx_4_pr/cv_dfx_4_pr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_cp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_cp_wrapper.tcl
