...
module rgb2gray_accel_xfMat2AXIvideo_24_9_1080_1920_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [23:0] img_out_435_dout;
input   img_out_435_empty_n;
output   img_out_435_read;
...
always @ (*) begin
    if (((icmp_ln197_reg_275 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_out_435_blk_n = img_out_435_empty_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln197_reg_275 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_out_435_read = 1'b1;
    end else begin
        img_out_435_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (stream_out_TREADY_int_regslice == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln197_reg_275 == 1'd0) & (stream_out_TREADY_int_regslice == 1'b0)) | ((icmp_ln197_reg_275 == 1'd0) & (img_out_435_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state6_io) | ((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (stream_out_TREADY_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((icmp_ln197_reg_275 == 1'd0) & (stream_out_TREADY_int_regslice == 1'b0)) | ((icmp_ln197_reg_275 == 1'd0) & (img_out_435_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = (((icmp_ln197_reg_275 == 1'd0) & (stream_out_TREADY_int_regslice == 1'b0)) | ((icmp_ln197_reg_275 == 1'd0) & (img_out_435_empty_n == 1'b0)));
end
...
endmodule //rgb2gray_accel_xfMat2AXIvideo_24_9_1080_1920_1_s
