...
module gray2rgb_accel_AXIvideo2xfMat_24_0_1080_1920_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
output   start_out;
output   start_write;
output  [7:0] img_gray_418_din;
input   img_gray_418_full_n;
output   img_gray_418_write;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_408_p2 == 1'd1) & (cmp743_i_reg_471 == 1'd1))) begin
        j_reg_215 <= 11'd0;
    end else if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (icmp_ln132_fu_423_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (icmp_ln132_fu_423_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((((start_reg_171 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | ((1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (or_ln138_fu_428_p2 == 1'd0) & (icmp_ln132_fu_423_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1)) | ((1'b1 == ap_CS_fsm_state8) & (last_1_reg_355 == 1'd0)))) begin
...
always @ (*) begin
    if (((~((stream_in_TVALID_int_regslice == 1'b0) & (last_1_reg_355 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (last_1_reg_355 == 1'd0)) | (~((start_reg_171 == 1'd0) & (stream_in_TVALID_int_regslice == 1'b0)) & (start_reg_171 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | ((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((1'b0 == ap_block_pp1_stage0_subdone) & (icmp_ln132_fu_423_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((1'b0 == ap_block_pp1_stage0_subdone) & (icmp_ln132_fu_423_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((icmp_ln132_reg_494 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_gray_418_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((icmp_ln132_reg_494 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_gray_418_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((icmp_ln132_reg_494 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (img_gray_418_full_n == 1'b0)) | ((stream_in_TVALID_int_regslice == 1'b0) & (ap_predicate_op72_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = ((icmp_ln132_reg_494 == 1'd0) & (img_gray_418_full_n == 1'b0));
end
...
assign img_gray_418_din = trunc_ln674_reg_502;
...
endmodule //gray2rgb_accel_AXIvideo2xfMat_24_0_1080_1920_1_s
