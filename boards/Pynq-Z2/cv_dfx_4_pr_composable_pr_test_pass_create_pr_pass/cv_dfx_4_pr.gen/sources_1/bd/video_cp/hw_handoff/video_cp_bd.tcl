...
proc create_hier_cell_dfx_decouplers { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 m_axi_dfx_pr_test_0

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 m_axi_dfx_pr_test_1
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_dfx_pr_test_0

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_dfx_pr_test_1
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_pr_test_0

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_pr_test_1
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_pr_test_0

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_pr_test_1
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_dfx_pr_test_0

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_dfx_pr_test_1
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_pr_test_0

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_pr_test_1
  ...
  # Create instance: dfx_decoupler_pr_test, and set properties
  set dfx_decoupler_pr_test [ create_bd_cell -type ip -vlnv xilinx.com:ip:dfx_decoupler:1.0 dfx_decoupler_pr_test ]
  set_property -dict [ list \
  ...
  # Create instance: pr_test_in0, and set properties
  set pr_test_in0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 pr_test_in0 ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
   CONFIG.HAS_TSTRB {0} \
  ...
  # Create instance: pr_test_in1, and set properties
  set pr_test_in1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 pr_test_in1 ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
   CONFIG.HAS_TSTRB {0} \
  ...
  # Create instance: pr_test_out0, and set properties
  set pr_test_out0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 pr_test_out0 ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
   CONFIG.HAS_TSTRB {0} \
  ...
  # Create instance: pr_test_out1, and set properties
  set pr_test_out1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 pr_test_out1 ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
   CONFIG.HAS_TSTRB {0} \
  ...
  # Create instance: xlslice_pr_test, and set properties
  set xlslice_pr_test [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_pr_test ]
  set_property -dict [ list \
   CONFIG.DIN_WIDTH {8} \
 ] $xlslice_pr_test
  ...
  connect_bd_intf_net -intf_net dfx_decoupler_0_rp_in_2 [get_bd_intf_pins dfx_decoupler_pr_test/rp_in_0] [get_bd_intf_pins pr_test_in0/S_AXIS]
  connect_bd_intf_net -intf_net dfx_decoupler_0_rp_in_3 [get_bd_intf_pins dfx_decoupler_pr_test/rp_in_1] [get_bd_intf_pins pr_test_in1/S_AXIS]
  ...
  connect_bd_intf_net -intf_net dfx_decoupler_0_s_out_2 [get_bd_intf_pins m_axis_dfx_pr_test_0] [get_bd_intf_pins dfx_decoupler_pr_test/s_out_0]
  connect_bd_intf_net -intf_net dfx_decoupler_0_s_out_3 [get_bd_intf_pins m_axis_dfx_pr_test_1] [get_bd_intf_pins dfx_decoupler_pr_test/s_out_1]
  ...
  connect_bd_intf_net -intf_net dfx_decoupler_pr_0_s_axi_lite2 [get_bd_intf_pins s_axi_pr_test_0] [get_bd_intf_pins dfx_decoupler_pr_test/s_axi_lite0]
  connect_bd_intf_net -intf_net dfx_decoupler_pr_0_s_axi_lite3 [get_bd_intf_pins s_axi_pr_test_1] [get_bd_intf_pins dfx_decoupler_pr_test/s_axi_lite1]
  ...
  connect_bd_intf_net -intf_net pr_0_in0_M_AXIS1 [get_bd_intf_pins m_axis_pr_test_0] [get_bd_intf_pins pr_test_in0/M_AXIS]
  connect_bd_intf_net -intf_net pr_0_in1_M_AXIS [get_bd_intf_pins m_axis_pr_0_1] [get_bd_intf_pins pr_0_in1/M_AXIS]
  connect_bd_intf_net -intf_net pr_0_in1_M_AXIS1 [get_bd_intf_pins m_axis_pr_test_1] [get_bd_intf_pins pr_test_in1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net pr_0_out0_M_AXIS1 [get_bd_intf_pins dfx_decoupler_pr_test/rp_out_0] [get_bd_intf_pins pr_test_out0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net pr_0_out1_M_AXIS1 [get_bd_intf_pins dfx_decoupler_pr_test/rp_out_1] [get_bd_intf_pins pr_test_out1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net pr_0_stream_out2 [get_bd_intf_pins s_axis_pr_test_0] [get_bd_intf_pins pr_test_out0/S_AXIS]
  connect_bd_intf_net -intf_net pr_0_stream_out3 [get_bd_intf_pins s_axis_pr_test_1] [get_bd_intf_pins pr_test_out1/S_AXIS]
  ...
  connect_bd_intf_net -intf_net video_M12_AXIS1 [get_bd_intf_pins s_axis_dfx_pr_test_0] [get_bd_intf_pins dfx_decoupler_pr_test/s_in_0]
  ...
  connect_bd_intf_net -intf_net video_M13_AXIS1 [get_bd_intf_pins s_axis_dfx_pr_test_1] [get_bd_intf_pins dfx_decoupler_pr_test/s_in_1]
  ...
  connect_bd_intf_net -intf_net video_M16_AXI1 [get_bd_intf_pins m_axi_dfx_pr_test_0] [get_bd_intf_pins dfx_decoupler_pr_test/rp_axi_lite0]
  ...
  connect_bd_intf_net -intf_net video_M21_AXI1 [get_bd_intf_pins m_axi_dfx_pr_test_1] [get_bd_intf_pins dfx_decoupler_pr_test/rp_axi_lite1]
  ...
  connect_bd_net -net dfx_decoupler_0_decouple_status1 [get_bd_pins dfx_decoupler_pr_test/decouple_status] [get_bd_pins status_xlconcat/In6]
  ...
  connect_bd_net -net peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins pr_0_in0/aresetn] [get_bd_pins pr_0_in1/aresetn] [get_bd_pins pr_0_out0/aresetn] [get_bd_pins pr_0_out1/aresetn] [get_bd_pins pr_1_in0/aresetn] [get_bd_pins pr_1_in1/aresetn] [get_bd_pins pr_1_out0/aresetn] [get_bd_pins pr_1_out1/aresetn] [get_bd_pins pr_test_in0/aresetn] [get_bd_pins pr_test_in1/aresetn] [get_bd_pins pr_test_out0/aresetn] [get_bd_pins pr_test_out1/aresetn]
  connect_bd_net -net ps7_0_FCLK_CLK1 [get_bd_pins clk_142M] [get_bd_pins pr_0_in0/aclk] [get_bd_pins pr_0_in1/aclk] [get_bd_pins pr_0_out0/aclk] [get_bd_pins pr_0_out1/aclk] [get_bd_pins pr_1_in0/aclk] [get_bd_pins pr_1_in1/aclk] [get_bd_pins pr_1_out0/aclk] [get_bd_pins pr_1_out1/aclk] [get_bd_pins pr_test_in0/aclk] [get_bd_pins pr_test_in1/aclk] [get_bd_pins pr_test_out0/aclk] [get_bd_pins pr_test_out1/aclk]
  connect_bd_net -net ps7_0_GPIO_O [get_bd_pins dfx_decouple] [get_bd_pins xlslice_pr_0/Din] [get_bd_pins xlslice_pr_1/Din] [get_bd_pins xlslice_pr_test/Din]
  ...
  connect_bd_net -net xlslice_pr_0_Dout1 [get_bd_pins dfx_decoupler_pr_test/decouple] [get_bd_pins xlslice_pr_test/Dout]
...
proc create_hier_cell_video { parentCell nameHier } {
  ...
  connect_bd_net -net aclk_1 [get_bd_pins clk_142M] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_vdma/m_axi_mm2s_aclk] [get_bd_pins axi_vdma/m_axi_s2mm_aclk] [get_bd_pins axi_vdma/m_axis_mm2s_aclk] [get_bd_pins axi_vdma/s_axis_s2mm_aclk] [get_bd_pins hdmi_in/clk_142M] [get_bd_pins hdmi_out/clk_142M]
  ...
  connect_bd_net -net rst_ps7_0_fclk1_peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins hdmi_in/periph_resetn_clk142M] [get_bd_pins hdmi_out/periph_resetn_clk142M]
...
proc create_hier_cell_composable { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S26_AXI_1 [get_bd_intf_pins S26_AXI] [get_bd_intf_pins dfx_decouplers/m_axi_dfx_pr_test_0]
  connect_bd_intf_net -intf_net S27_AXI_1 [get_bd_intf_pins S27_AXI] [get_bd_intf_pins dfx_decouplers/m_axi_dfx_pr_test_1]
  ...
  connect_bd_intf_net -intf_net dfx_decouplers_m_axis_dfx_pr_test_0 [get_bd_intf_pins axis_switch/S10_AXIS] [get_bd_intf_pins dfx_decouplers/m_axis_dfx_pr_test_0]
  connect_bd_intf_net -intf_net dfx_decouplers_m_axis_dfx_pr_test_1 [get_bd_intf_pins axis_switch/S11_AXIS] [get_bd_intf_pins dfx_decouplers/m_axis_dfx_pr_test_1]
  ...
  connect_bd_intf_net -intf_net s_axis_dfx_pr_test_0_1 [get_bd_intf_pins axis_switch/M10_AXIS] [get_bd_intf_pins dfx_decouplers/s_axis_dfx_pr_test_0]
  connect_bd_intf_net -intf_net s_axis_dfx_pr_test_1_1 [get_bd_intf_pins axis_switch/M11_AXIS] [get_bd_intf_pins dfx_decouplers/s_axis_dfx_pr_test_1]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins clk_142M] [get_bd_pins axis_dwidth_24_48/aclk] [get_bd_pins axis_dwidth_48_24/aclk] [get_bd_pins axis_fifo_hdmi_out/s_axis_aclk] [get_bd_pins axis_switch/aclk] [get_bd_pins axis_switch/s_axi_ctrl_aclk] [get_bd_pins dfx_decouplers/clk_142M] [get_bd_pins gray2rgb_accel/ap_clk] [get_bd_pins pipeline_control/s_axi_aclk] [get_bd_pins pr_0/clk_142M] [get_bd_pins pr_1/clk_142M] [get_bd_pins ps_user_soft_reset/slowest_sync_clk] [get_bd_pins rgb2gray_accel/ap_clk] [get_bd_pins rgb2hsv_accel/ap_clk]
  ...
  connect_bd_net -net soft_peripheral_aresetn [get_bd_pins axis_dwidth_24_48/aresetn] [get_bd_pins axis_dwidth_48_24/aresetn] [get_bd_pins axis_fifo_hdmi_out/s_axis_aresetn] [get_bd_pins dfx_decouplers/periph_resetn_clk142M] [get_bd_pins gray2rgb_accel/ap_rst_n] [get_bd_pins pr_0/periph_resetn_clk142M] [get_bd_pins pr_1/periph_resetn_clk142M] [get_bd_pins ps_user_soft_reset/peripheral_aresetn] [get_bd_pins rgb2gray_accel/ap_rst_n] [get_bd_pins rgb2hsv_accel/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M26_AXI [get_bd_intf_pins axi_interconnect_0/M26_AXI] [get_bd_intf_pins composable/S26_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M27_AXI [get_bd_intf_pins axi_interconnect_0/M27_AXI] [get_bd_intf_pins composable/S27_AXI]
