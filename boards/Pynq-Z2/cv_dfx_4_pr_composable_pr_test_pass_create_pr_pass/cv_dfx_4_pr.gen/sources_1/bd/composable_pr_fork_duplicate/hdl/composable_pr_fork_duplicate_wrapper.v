...
//Command     : generate_target composable_pr_fork_duplicate_wrapper.bd
//Design      : composable_pr_fork_duplicate_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module composable_pr_fork_duplicate_wrapper
   (clk_142M,
  ...
  composable_pr_fork_duplicate composable_pr_fork_duplicate_i
       (.clk_142M(clk_142M),
