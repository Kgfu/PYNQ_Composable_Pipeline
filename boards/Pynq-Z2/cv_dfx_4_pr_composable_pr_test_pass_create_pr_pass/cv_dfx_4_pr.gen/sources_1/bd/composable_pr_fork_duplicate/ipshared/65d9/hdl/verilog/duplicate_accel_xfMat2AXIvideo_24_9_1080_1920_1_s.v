...
module duplicate_accel_xfMat2AXIvideo_24_9_1080_1920_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [23:0] img_out0_435_dout;
input   img_out0_435_empty_n;
output   img_out0_435_read;
...
reg    img_1_blk_n;
reg    img_2_blk_n;
reg    stream_out1_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln197_reg_275_pp0_iter1_reg;
reg   [10:0] j_reg_145;
reg   [0:0] sof_6_reg_156;
...
reg   [0:0] ap_phi_mux_sof_6_phi_fu_161_p4;
reg   [0:0] sof_fu_82;
reg    ap_block_state1;
...
reg    ap_idle_pp0;
wire    ap_enable_pp0;
reg    stream_out1_TVALID_int_regslice;
wire    stream_out1_TREADY_int_regslice;
...
regslice_both_AXI_video_strm_V_data_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .data_in(img_out0_435_dout),
    .vld_in(stream_out1_TVALID_int_regslice),
    .ack_in(stream_out1_TREADY_int_regslice),
    .data_out(stream_out1_TDATA),
    .vld_out(regslice_both_AXI_video_strm_V_data_V_U_vld_out),
    .ack_out(stream_out1_TREADY),
...
regslice_both_AXI_video_strm_V_user_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .data_in(ap_phi_mux_sof_6_phi_fu_161_p4),
    .vld_in(stream_out1_TVALID_int_regslice),
    .ack_in(regslice_both_AXI_video_strm_V_user_V_U_ack_in_dummy),
    .data_out(stream_out1_TUSER),
...
always @ (posedge ap_clk) begin
    if (((cmp71_i_reg_252 == 1'd1) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln195_fu_198_p2 == 1'd1) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0))) begin
        ...
        j_reg_145 <= j_2_fu_203_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((cmp71_i_reg_252 == 1'd1) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln195_fu_198_p2 == 1'd1) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0))) begin
        sof_6_reg_156 <= sof_fu_82;
...
always @ (*) begin
    if (((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_phi_mux_sof_6_phi_fu_161_p4 = 1'd0;
    end else begin
        ap_phi_mux_sof_6_phi_fu_161_p4 = sof_6_reg_156;
    end
end
...
always @ (*) begin
    if (((icmp_ln197_reg_275 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_out0_435_blk_n = img_out0_435_empty_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln197_reg_275 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_out0_435_read = 1'b1;
    end else begin
        img_out0_435_read = 1'b0;
    end
end
...
always @ (*) begin
    if ((((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0)) | ((icmp_ln197_reg_275 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        stream_out1_TDATA_blk_n = stream_out1_TREADY_int_regslice;
    end else begin
        stream_out1_TDATA_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((icmp_ln197_reg_275 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        stream_out1_TVALID_int_regslice = 1'b1;
    end else begin
        stream_out1_TVALID_int_regslice = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (stream_out1_TREADY_int_regslice == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln197_reg_275 == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0)) | ((icmp_ln197_reg_275 == 1'd0) & (img_out0_435_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state6_io) | ((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((icmp_ln197_reg_275 == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0)) | ((icmp_ln197_reg_275 == 1'd0) & (img_out0_435_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state6_io) | ((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((icmp_ln197_reg_275 == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0)) | ((icmp_ln197_reg_275 == 1'd0) & (img_out0_435_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state5_io = ((icmp_ln197_reg_275 == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = (((icmp_ln197_reg_275 == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0)) | ((icmp_ln197_reg_275 == 1'd0) & (img_out0_435_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state6_io = ((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state6_pp0_stage0_iter2 = ((icmp_ln197_reg_275_pp0_iter1_reg == 1'd0) & (stream_out1_TREADY_int_regslice == 1'b0));
end
...
assign i_2_fu_185_p2 = (i_reg_134 + 11'd1);
...
assign j_2_fu_203_p2 = (j_reg_145 + 11'd1);

assign stream_out1_TVALID = regslice_both_AXI_video_strm_V_data_V_U_vld_out;
...
endmodule //duplicate_accel_xfMat2AXIvideo_24_9_1080_1920_1_s
