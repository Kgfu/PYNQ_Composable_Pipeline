...
-- Date        : Wed Mar 16 11:41:40 2022
-- Host        : ubuntu3 running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/willychiang/Desktop/PYNQ_Composable_Pipeline/boards/Pynq-Z2/cv_dfx_4_pr/cv_dfx_4_pr.gen/sources_1/bd/composable_pr_fork_rgb2xyz/composable_pr_fork_rgb2xyz_sim_netlist.vhdl
...
entity composable_pr_fork_rgb2xyz is
  port (
  ...
  attribute NotValidForBitStream of composable_pr_fork_rgb2xyz : entity is true;
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of composable_pr_fork_rgb2xyz : entity is "composable_pr_fork_rgb2xyz.hwdef";
end composable_pr_fork_rgb2xyz;

architecture STRUCTURE of composable_pr_fork_rgb2xyz is
  component composable_pr_fork_rgb2xyz_composable_pr_fork_rgb2xyz_rgb2xyz_accel_0 is
  port (
  ...
  end component composable_pr_fork_rgb2xyz_composable_pr_fork_rgb2xyz_rgb2xyz_accel_0;
  signal \<const0>\ : STD_LOGIC;
  signal NLW_rgb2xyz_accel_interrupt_UNCONNECTED : STD_LOGIC;
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of rgb2xyz_accel : label is "rgb2xyz_accel,Vivado 2020.2.2";
...
begin
  stream_out1_tdata(23) <= \<const0>\;
  stream_out1_tdata(22) <= \<const0>\;
  stream_out1_tdata(21) <= \<const0>\;
  stream_out1_tdata(20) <= \<const0>\;
  stream_out1_tdata(19) <= \<const0>\;
  stream_out1_tdata(18) <= \<const0>\;
  stream_out1_tdata(17) <= \<const0>\;
  stream_out1_tdata(16) <= \<const0>\;
  stream_out1_tdata(15) <= \<const0>\;
  stream_out1_tdata(14) <= \<const0>\;
  stream_out1_tdata(13) <= \<const0>\;
  stream_out1_tdata(12) <= \<const0>\;
  stream_out1_tdata(11) <= \<const0>\;
  stream_out1_tdata(10) <= \<const0>\;
  stream_out1_tdata(9) <= \<const0>\;
  stream_out1_tdata(8) <= \<const0>\;
  stream_out1_tdata(7) <= \<const0>\;
  stream_out1_tdata(6) <= \<const0>\;
  stream_out1_tdata(5) <= \<const0>\;
  stream_out1_tdata(4) <= \<const0>\;
  stream_out1_tdata(3) <= \<const0>\;
  stream_out1_tdata(2) <= \<const0>\;
  stream_out1_tdata(1) <= \<const0>\;
  stream_out1_tdata(0) <= \<const0>\;
  stream_out1_tdest(0) <= \<const0>\;
  stream_out1_tid(0) <= \<const0>\;
  stream_out1_tkeep(2) <= \<const0>\;
  stream_out1_tkeep(1) <= \<const0>\;
  stream_out1_tkeep(0) <= \<const0>\;
  stream_out1_tlast(0) <= \<const0>\;
  stream_out1_tstrb(2) <= \<const0>\;
  stream_out1_tstrb(1) <= \<const0>\;
  stream_out1_tstrb(0) <= \<const0>\;
  stream_out1_tuser(0) <= \<const0>\;
  stream_out1_tvalid <= \<const0>\;
GND: unisim.vcomponents.GND
     port map (
      G => \<const0>\
    );
rgb2xyz_accel: component composable_pr_fork_rgb2xyz_composable_pr_fork_rgb2xyz_rgb2xyz_accel_0
     port map (
      ap_clk => clk_142M,
      ap_rst_n => periph_resetn_clk142M,
      interrupt => NLW_rgb2xyz_accel_interrupt_UNCONNECTED,
