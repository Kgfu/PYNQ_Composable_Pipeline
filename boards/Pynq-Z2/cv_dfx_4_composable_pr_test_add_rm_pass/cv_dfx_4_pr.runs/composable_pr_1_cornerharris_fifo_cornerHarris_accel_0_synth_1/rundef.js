...
ISEStep( "vivado",
         "-log composable_pr_1_cornerharris_fifo_cornerHarris_accel_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source composable_pr_1_cornerharris_fifo_cornerHarris_accel_0.tcl" );
