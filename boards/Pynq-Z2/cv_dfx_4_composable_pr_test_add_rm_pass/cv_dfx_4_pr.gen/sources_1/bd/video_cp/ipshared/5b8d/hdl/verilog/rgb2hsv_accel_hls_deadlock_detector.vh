...
always @(negedge reset or posedge clock) begin
    ...
    rgb2hsv_accel_hls_deadlock_detect_unit #(4, 0, 2, 2) rgb2hsv_accel_hls_deadlock_detect_unit_0 (
        .reset(reset),
        .clock(clock),
    ...
    rgb2hsv_accel_hls_deadlock_detect_unit #(4, 1, 2, 2) rgb2hsv_accel_hls_deadlock_detect_unit_1 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~start_for_rgb2hsv_9_1080_1920_1_U0_U.if_full_n & AXIvideo2xfMat_24_9_1080_1920_1_U0.ap_start & ~AXIvideo2xfMat_24_9_1080_1920_1_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_rgb2hsv_9_1080_1920_1_U0_U.if_read);
    ...
    // Process: rgb2hsv_9_1080_1920_1_U0
    rgb2hsv_accel_hls_deadlock_detect_unit #(4, 2, 2, 2) rgb2hsv_accel_hls_deadlock_detect_unit_2 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~rgb2hsv_9_1080_1920_1_U0.img_in_419_blk_n) | (~rgb2hsv_9_1080_1920_1_U0.p_src_mat_rows_blk_n) | (~rgb2hsv_9_1080_1920_1_U0.p_src_mat_cols_blk_n);
    assign proc_2_data_PIPO_blk[0] = 1'b0;
    assign proc_2_start_FIFO_blk[0] = 1'b0 | (~start_for_rgb2hsv_9_1080_1920_1_U0_U.if_empty_n & rgb2hsv_9_1080_1920_1_U0.ap_idle & ~start_for_rgb2hsv_9_1080_1920_1_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[0] = 1'b0;
    assign proc_2_input_sync_blk[0] = 1'b0;
    assign proc_2_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_2[0] = dl_detect_out ? proc_dep_vld_vec_2_reg[0] : (proc_2_data_FIFO_blk[0] | proc_2_data_PIPO_blk[0] | proc_2_start_FIFO_blk[0] | proc_2_TLF_FIFO_blk[0] | proc_2_input_sync_blk[0] | proc_2_output_sync_blk[0]);
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~rgb2hsv_9_1080_1920_1_U0.img_out_420_blk_n);
    ...
    rgb2hsv_accel_hls_deadlock_detect_unit #(4, 3, 2, 2) rgb2hsv_accel_hls_deadlock_detect_unit_3 (
        .reset(reset),
        .clock(clock),
...
`include "rgb2hsv_accel_hls_deadlock_report_unit.vh"
