...
//Date        : Wed Apr 20 20:48:48 2022
//Host        : ubuntu3 running 64-bit Ubuntu 20.04.3 LTS
//Command     : generate_target composable_pr_test_dilate.bd
//Design      : composable_pr_test_dilate
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "composable_pr_test_dilate,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=composable_pr_test_dilate,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=2,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "composable_pr_test_dilate.hwdef" *) 
module composable_pr_test_dilate
   (clk_142M,
    ...
    stream_out1_tuser,
    stream_out1_tvalid);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_142M CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_142M, ASSOCIATED_BUSIF s_axi_control0:s_axi_control1:stream_in0:stream_in1:stream_out0:stream_out1, ASSOCIATED_RESET periph_resetn_clk142M, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input clk_142M;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_control0 ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axi_control0, ADDR_WIDTH 31, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN composable_pr_test_dilate_clk_142M, DATA_WIDTH 32, FREQ_HZ 142857132, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [6:0]s_axi_control0_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_control1 ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axi_control1, ADDR_WIDTH 31, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN composable_pr_test_dilate_clk_142M, DATA_WIDTH 32, FREQ_HZ 142857132, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [6:0]s_axi_control1_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 stream_in0 TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME stream_in0, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1" *) input [23:0]stream_in0_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 stream_in1 TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME stream_in1, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1" *) input [23:0]stream_in1_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 stream_out0 TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME stream_out0, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1" *) output [23:0]stream_out0_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 stream_out1 TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME stream_out1, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1" *) output [23:0]stream_out1_tdata;
  ...
  wire clk_142M_1;
  wire [23:0]dilate_accel1_stream_out_TDATA;
  wire [0:0]dilate_accel1_stream_out_TDEST;
  wire [0:0]dilate_accel1_stream_out_TID;
  wire [2:0]dilate_accel1_stream_out_TKEEP;
  wire [0:0]dilate_accel1_stream_out_TLAST;
  wire dilate_accel1_stream_out_TREADY;
  wire [2:0]dilate_accel1_stream_out_TSTRB;
  wire [0:0]dilate_accel1_stream_out_TUSER;
  wire dilate_accel1_stream_out_TVALID;
  wire [23:0]erode_accel_stream_out_TDATA;
  wire [0:0]erode_accel_stream_out_TDEST;
  wire [0:0]erode_accel_stream_out_TID;
  wire [2:0]erode_accel_stream_out_TKEEP;
  wire [0:0]erode_accel_stream_out_TLAST;
  wire erode_accel_stream_out_TREADY;
  wire [2:0]erode_accel_stream_out_TSTRB;
  wire [0:0]erode_accel_stream_out_TUSER;
  wire erode_accel_stream_out_TVALID;
  ...
  wire [6:0]s_axi_control1_1_ARADDR;
  wire s_axi_control1_1_ARREADY;
  wire s_axi_control1_1_ARVALID;
  wire [6:0]s_axi_control1_1_AWADDR;
  wire s_axi_control1_1_AWREADY;
  wire s_axi_control1_1_AWVALID;
  wire s_axi_control1_1_BREADY;
  wire [1:0]s_axi_control1_1_BRESP;
  wire s_axi_control1_1_BVALID;
  wire [31:0]s_axi_control1_1_RDATA;
  wire s_axi_control1_1_RREADY;
  wire [1:0]s_axi_control1_1_RRESP;
  wire s_axi_control1_1_RVALID;
  wire [31:0]s_axi_control1_1_WDATA;
  wire s_axi_control1_1_WREADY;
  wire [3:0]s_axi_control1_1_WSTRB;
  wire s_axi_control1_1_WVALID;
  ...
  assign dilate_accel1_stream_out_TREADY = stream_out0_tready;
  assign erode_accel_stream_out_TREADY = stream_out1_tready;
  ...
  assign s_axi_control1_1_ARADDR = s_axi_control1_araddr[6:0];
  assign s_axi_control1_1_ARVALID = s_axi_control1_arvalid;
  assign s_axi_control1_1_AWADDR = s_axi_control1_awaddr[6:0];
  assign s_axi_control1_1_AWVALID = s_axi_control1_awvalid;
  assign s_axi_control1_1_BREADY = s_axi_control1_bready;
  assign s_axi_control1_1_RREADY = s_axi_control1_rready;
  assign s_axi_control1_1_WDATA = s_axi_control1_wdata[31:0];
  assign s_axi_control1_1_WSTRB = s_axi_control1_wstrb[3:0];
  assign s_axi_control1_1_WVALID = s_axi_control1_wvalid;
  assign s_axi_control1_arready = s_axi_control1_1_ARREADY;
  assign s_axi_control1_awready = s_axi_control1_1_AWREADY;
  assign s_axi_control1_bresp[1:0] = s_axi_control1_1_BRESP;
  assign s_axi_control1_bvalid = s_axi_control1_1_BVALID;
  assign s_axi_control1_rdata[31:0] = s_axi_control1_1_RDATA;
  assign s_axi_control1_rresp[1:0] = s_axi_control1_1_RRESP;
  assign s_axi_control1_rvalid = s_axi_control1_1_RVALID;
  assign s_axi_control1_wready = s_axi_control1_1_WREADY;
  ...
  assign stream_out0_tdata[23:0] = dilate_accel1_stream_out_TDATA;
  assign stream_out0_tdest[0] = dilate_accel1_stream_out_TDEST;
  assign stream_out0_tid[0] = dilate_accel1_stream_out_TID;
  assign stream_out0_tkeep[2:0] = dilate_accel1_stream_out_TKEEP;
  assign stream_out0_tlast[0] = dilate_accel1_stream_out_TLAST;
  assign stream_out0_tstrb[2:0] = dilate_accel1_stream_out_TSTRB;
  assign stream_out0_tuser[0] = dilate_accel1_stream_out_TUSER;
  assign stream_out0_tvalid = dilate_accel1_stream_out_TVALID;
  assign stream_out1_tdata[23:0] = erode_accel_stream_out_TDATA;
  assign stream_out1_tdest[0] = erode_accel_stream_out_TDEST;
  assign stream_out1_tid[0] = erode_accel_stream_out_TID;
  assign stream_out1_tkeep[2:0] = erode_accel_stream_out_TKEEP;
  assign stream_out1_tlast[0] = erode_accel_stream_out_TLAST;
  assign stream_out1_tstrb[2:0] = erode_accel_stream_out_TSTRB;
  assign stream_out1_tuser[0] = erode_accel_stream_out_TUSER;
  assign stream_out1_tvalid = erode_accel_stream_out_TVALID;
  composable_pr_test_dilate_dilate_accel_1 dilate_accel1
       (.ap_clk(clk_142M_1),
        .ap_rst_n(periph_resetn_clk142M_1),
        .s_axi_control_ARADDR(s_axi_control0_1_ARADDR),
        .s_axi_control_ARREADY(s_axi_control0_1_ARREADY),
        .s_axi_control_ARVALID(s_axi_control0_1_ARVALID),
        .s_axi_control_AWADDR(s_axi_control0_1_AWADDR),
        ...
        .stream_out_TDATA(dilate_accel1_stream_out_TDATA),
        .stream_out_TDEST(dilate_accel1_stream_out_TDEST),
        .stream_out_TID(dilate_accel1_stream_out_TID),
        .stream_out_TKEEP(dilate_accel1_stream_out_TKEEP),
        .stream_out_TLAST(dilate_accel1_stream_out_TLAST),
        .stream_out_TREADY(dilate_accel1_stream_out_TREADY),
        .stream_out_TSTRB(dilate_accel1_stream_out_TSTRB),
        .stream_out_TUSER(dilate_accel1_stream_out_TUSER),
        .stream_out_TVALID(dilate_accel1_stream_out_TVALID));
  composable_pr_test_dilate_dilate_accel_0 dilate_accel2
       (.ap_clk(clk_142M_1),
        .ap_rst_n(periph_resetn_clk142M_1),
        .s_axi_control_ARADDR(s_axi_control1_1_ARADDR),
        .s_axi_control_ARREADY(s_axi_control1_1_ARREADY),
        .s_axi_control_ARVALID(s_axi_control1_1_ARVALID),
        .s_axi_control_AWADDR(s_axi_control1_1_AWADDR),
        .s_axi_control_AWREADY(s_axi_control1_1_AWREADY),
        .s_axi_control_AWVALID(s_axi_control1_1_AWVALID),
        .s_axi_control_BREADY(s_axi_control1_1_BREADY),
        .s_axi_control_BRESP(s_axi_control1_1_BRESP),
        .s_axi_control_BVALID(s_axi_control1_1_BVALID),
        .s_axi_control_RDATA(s_axi_control1_1_RDATA),
        .s_axi_control_RREADY(s_axi_control1_1_RREADY),
        .s_axi_control_RRESP(s_axi_control1_1_RRESP),
        .s_axi_control_RVALID(s_axi_control1_1_RVALID),
        .s_axi_control_WDATA(s_axi_control1_1_WDATA),
        .s_axi_control_WREADY(s_axi_control1_1_WREADY),
        .s_axi_control_WSTRB(s_axi_control1_1_WSTRB),
        .s_axi_control_WVALID(s_axi_control1_1_WVALID),
        .stream_in_TDATA(stream_in1_1_TDATA),
        .stream_in_TDEST(stream_in1_1_TDEST),
        .stream_in_TID(stream_in1_1_TID),
        .stream_in_TKEEP(stream_in1_1_TKEEP),
        .stream_in_TLAST(stream_in1_1_TLAST),
        .stream_in_TREADY(stream_in1_1_TREADY),
        .stream_in_TSTRB(stream_in1_1_TSTRB),
        .stream_in_TUSER(stream_in1_1_TUSER),
        .stream_in_TVALID(stream_in1_1_TVALID),
        .stream_out_TDATA(erode_accel_stream_out_TDATA),
        .stream_out_TDEST(erode_accel_stream_out_TDEST),
        .stream_out_TID(erode_accel_stream_out_TID),
        .stream_out_TKEEP(erode_accel_stream_out_TKEEP),
        .stream_out_TLAST(erode_accel_stream_out_TLAST),
        .stream_out_TREADY(erode_accel_stream_out_TREADY),
        .stream_out_TSTRB(erode_accel_stream_out_TSTRB),
        .stream_out_TUSER(erode_accel_stream_out_TUSER),
        .stream_out_TVALID(erode_accel_stream_out_TVALID));
endmodule
