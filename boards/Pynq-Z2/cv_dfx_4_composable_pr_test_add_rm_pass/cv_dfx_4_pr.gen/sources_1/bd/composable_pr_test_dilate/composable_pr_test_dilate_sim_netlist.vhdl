...
--               /home/willychiang/Desktop/PYNQ_Composable_Pipeline/boards/Pynq-Z2/cv_dfx_4_pr/cv_dfx_4_pr.gen/sources_1/bd/composable_pr_test_dilate/composable_pr_test_dilate_sim_netlist.vhdl
...
entity composable_pr_test_dilate is
  ...
  attribute NotValidForBitStream of composable_pr_test_dilate : entity is true;
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of composable_pr_test_dilate : entity is "composable_pr_test_dilate.hwdef";
end composable_pr_test_dilate;

architecture STRUCTURE of composable_pr_test_dilate is
  component composable_pr_test_dilate_composable_pr_test_dilate_dilate_accel_1 is
  port (
  ...
  end component composable_pr_test_dilate_composable_pr_test_dilate_dilate_accel_1;
  component composable_pr_test_dilate_composable_pr_test_dilate_dilate_accel_0 is
  port (
    s_axi_control_AWADDR : in STD_LOGIC_VECTOR ( 6 downto 0 );
    s_axi_control_AWVALID : in STD_LOGIC;
    s_axi_control_AWREADY : out STD_LOGIC;
  ...
  end component composable_pr_test_dilate_composable_pr_test_dilate_dilate_accel_0;
  signal NLW_dilate_accel1_interrupt_UNCONNECTED : STD_LOGIC;
  signal NLW_dilate_accel2_interrupt_UNCONNECTED : STD_LOGIC;
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of dilate_accel1 : label is "dilate_accel,Vivado 2020.2.2";
  attribute X_CORE_INFO of dilate_accel2 : label is "dilate_accel,Vivado 2020.2.2";
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk_142M : signal is "xilinx.com:signal:clock:1.0 CLK.CLK_142M CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk_142M : signal is "XIL_INTERFACENAME CLK.CLK_142M, ASSOCIATED_BUSIF s_axi_control0:s_axi_control1:stream_in0:stream_in1:stream_out0:stream_out1, ASSOCIATED_RESET periph_resetn_clk142M, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
  ...
  attribute X_INTERFACE_PARAMETER of s_axi_control1_araddr : signal is "XIL_INTERFACENAME s_axi_control1, ADDR_WIDTH 31, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN composable_pr_test_dilate_clk_142M, DATA_WIDTH 32, FREQ_HZ 142857132, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0";
  ...
  attribute X_INTERFACE_PARAMETER of stream_in0_tdata : signal is "XIL_INTERFACENAME stream_in0, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
  ...
  attribute X_INTERFACE_PARAMETER of stream_in1_tdata : signal is "XIL_INTERFACENAME stream_in1, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
  ...
  attribute X_INTERFACE_PARAMETER of stream_out0_tdata : signal is "XIL_INTERFACENAME stream_out0, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
  ...
  attribute X_INTERFACE_PARAMETER of stream_out1_tdata : signal is "XIL_INTERFACENAME stream_out1, CLK_DOMAIN composable_pr_test_dilate_clk_142M, FREQ_HZ 142857132, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
...
begin
dilate_accel1: component composable_pr_test_dilate_composable_pr_test_dilate_dilate_accel_1
     port map (
      ap_clk => clk_142M,
      ap_rst_n => periph_resetn_clk142M,
      interrupt => NLW_dilate_accel1_interrupt_UNCONNECTED,
...
dilate_accel2: component composable_pr_test_dilate_composable_pr_test_dilate_dilate_accel_0
     port map (
      ap_clk => clk_142M,
      ap_rst_n => periph_resetn_clk142M,
      interrupt => NLW_dilate_accel2_interrupt_UNCONNECTED,
