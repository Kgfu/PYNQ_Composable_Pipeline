...
module cornerHarris_accel_xFCornerHarrisDetector_3_3_0_1080_1920_1_0_1_1_12_1920_5_12_false_entry39 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((k_out_full_n == 1'b0) | (real_start == 1'b0) | (p_threshold_out_full_n == 1'b0) | (img_width_out4_full_n == 1'b0) | (img_width_out3_full_n == 1'b0) | (img_width_out_full_n == 1'b0) | (img_height_out2_full_n == 1'b0) | (img_height_out1_full_n == 1'b0) | (img_height_out_full_n == 1'b0) | (p_src_mat_cols_out_full_n == 1'b0) | (p_src_mat_rows_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    ap_block_state1 = ((k_out_full_n == 1'b0) | (real_start == 1'b0) | (p_threshold_out_full_n == 1'b0) | (img_width_out4_full_n == 1'b0) | (img_width_out3_full_n == 1'b0) | (img_width_out_full_n == 1'b0) | (img_height_out2_full_n == 1'b0) | (img_height_out1_full_n == 1'b0) | (img_height_out_full_n == 1'b0) | (p_src_mat_cols_out_full_n == 1'b0) | (p_src_mat_rows_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign p_src_mat_cols_out_din = p_read1;

assign p_src_mat_rows_out_din = p_read;

assign p_threshold_out_din = p_threshold;

assign start_out = real_start;

endmodule //cornerHarris_accel_xFCornerHarrisDetector_3_3_0_1080_1920_1_0_1_1_12_1920_5_12_false_entry39
