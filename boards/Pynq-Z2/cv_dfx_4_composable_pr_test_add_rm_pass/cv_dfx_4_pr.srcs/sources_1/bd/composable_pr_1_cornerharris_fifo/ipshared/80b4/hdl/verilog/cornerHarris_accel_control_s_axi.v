...
// ==============================================================
`timescale 1ns/1ps
module cornerHarris_accel_control_s_axi
#(parameter
...
//        bit 15~0 - threshold[15:0] (Read/Write)
//        others   - reserved
// 0x24 : reserved
// 0x28 : Data signal of k
//        bit 15~0 - k[15:0] (Read/Write)
//        others   - reserved
// 0x2c : reserved
...
always @(posedge ACLK) begin
    if (ARESET)
        int_threshold[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_THRESHOLD_DATA_0)
            int_threshold[15:0] <= (WDATA[31:0] & wmask) | (int_threshold[15:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_K_DATA_0)
            int_k[15:0] <= (WDATA[31:0] & wmask) | (int_k[15:0] & ~wmask);
    end
end
