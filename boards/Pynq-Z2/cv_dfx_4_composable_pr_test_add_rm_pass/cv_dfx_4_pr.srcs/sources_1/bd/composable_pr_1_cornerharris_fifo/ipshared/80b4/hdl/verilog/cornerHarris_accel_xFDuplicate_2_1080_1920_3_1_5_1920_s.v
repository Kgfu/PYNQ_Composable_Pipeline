...
module cornerHarris_accel_xFDuplicate_2_1080_1920_3_1_5_1920_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [10:0] col_V_reg_121;
reg   [10:0] img_height_read_reg_154;
reg   [10:0] img_width_read_reg_159;
wire   [10:0] row_V_7_fu_132_p2;
reg   [10:0] row_V_7_reg_164;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln37_fu_138_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln37_fu_138_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln43_fu_149_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        col_V_reg_121 <= col_V_10_fu_143_p2;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln37_fu_138_p2 == 1'd0))) begin
        col_V_reg_121 <= 11'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln43_reg_178 <= icmp_ln43_fu_149_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        img_height_read_reg_154 <= img_height_dout;
        img_width_read_reg_159 <= img_width_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        row_V_7_reg_164 <= row_V_7_fu_132_p2;
    end
end

always @ (*) begin
    if ((icmp_ln43_fu_149_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln37_fu_138_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln43_reg_178 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln43_reg_178 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln43_fu_149_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln43_fu_149_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln43_reg_178 == 1'd0) & (gradx2_mat_413_full_n == 1'b0)) | ((icmp_ln43_reg_178 == 1'd0) & (gradx1_mat_411_full_n == 1'b0)) | ((icmp_ln43_reg_178 == 1'd0) & (gradx_mat_49_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln43_reg_178 == 1'd0) & (gradx2_mat_413_full_n == 1'b0)) | ((icmp_ln43_reg_178 == 1'd0) & (gradx1_mat_411_full_n == 1'b0)) | ((icmp_ln43_reg_178 == 1'd0) & (gradx_mat_49_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln43_reg_178 == 1'd0) & (gradx2_mat_413_full_n == 1'b0)) | ((icmp_ln43_reg_178 == 1'd0) & (gradx1_mat_411_full_n == 1'b0)) | ((icmp_ln43_reg_178 == 1'd0) & (gradx_mat_49_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((icmp_ln43_reg_178 == 1'd0) & (gradx2_mat_413_full_n == 1'b0)) | ((icmp_ln43_reg_178 == 1'd0) & (gradx1_mat_411_full_n == 1'b0)) | ((icmp_ln43_reg_178 == 1'd0) & (gradx_mat_49_empty_n == 1'b0)));
end
...
assign col_V_10_fu_143_p2 = (col_V_reg_121 + 11'd1);

assign gradx1_mat_411_din = gradx_mat_49_dout;

assign gradx2_mat_413_din = gradx_mat_49_dout;

assign icmp_ln37_fu_138_p2 = ((row_V_reg_110 == img_height_read_reg_154) ? 1'b1 : 1'b0);

assign icmp_ln43_fu_149_p2 = ((col_V_reg_121 == img_width_read_reg_159) ? 1'b1 : 1'b0);

assign img_height_out_din = img_height_dout;

assign img_width_out_din = img_width_dout;

assign row_V_7_fu_132_p2 = (row_V_reg_110 + 11'd1);

assign start_out = real_start;

endmodule //cornerHarris_accel_xFDuplicate_2_1080_1920_3_1_5_1920_s
